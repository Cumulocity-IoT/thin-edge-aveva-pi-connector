...
CONFIG = {
    ...
    "ENDPOINT": "service/config-management/config"
}

# Globals
pi_config: Dict[str, Any] = {}
datapoint_list: Dict[str, Any] = {}
...
def load_configuration():
    ...
    pi_device_config = read_json_file(CONFIG["PI_DEVICE_CONFIG"])
    CONFIG.update(pi_device_config)
    if not pi_config:
...
def load_datapoints():
    ...
    datapoint_list = read_json_file(CONFIG["PI_DATAPOINTS_FILE"])
